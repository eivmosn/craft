...
export default defineConfig({
  ...
  shortcuts: {
    'b': 'border border-solid b-[var(--x-border)]',
    'b-top': 'b-l b-t-solid b-[var(--x-border)]',
    'b-left': 'b-l b-l-solid b-[var(--x-border)]',
    'b-right': 'b-r b-r-solid b-[var(--x-border)]',
    'b-bottom': 'b-b b-b-solid b-[var(--x-border)]',
