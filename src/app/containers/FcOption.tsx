...
export default defineComponent({
  ...
  render() {
    return (<div class={['relative fc select-none p-4px hover:(outline-blue outline outline-dashed)', this.active && 'outline-blue outline!']}>
      {this.$slots.default?.()}
      <div class="option-mask absolute inset-0 z-5"></div>
      {
        this.active && <NButtonGroup size="tiny" class="absolute z-6 -bottom-24px -right-1px">
