  ...
  render() {
    return (
      <div class="min-w-48px w-48px b-right b-[var(--fc-border-base)] bg-[var(--fc-background-light)] fc flex-col justify-start gap-20px py-20px text-[var(--fc-icon-color)]">
        ...
        <svg onClick={() => this.$emit('click', 'code')} width="24" height="24" viewBox="0 0 32 32"><path fill="currentColor" d="m31 16l-7 7l-1.41-1.41L28.17 16l-5.58-5.59L24 9l7 7zM1 16l7-7l1.41 1.41L3.83 16l5.58 5.59L8 23l-7-7zm11.42 9.484L17.64 6l1.932.517L14.352 26z" /></svg>
        <svg width="24" height="24" viewBox="0 0 32 32">
